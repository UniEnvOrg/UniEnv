...
class ArrayAPIArray(Protocol):
    ...
    def __dlpack_device__(self: _ARR_C, /) -> Tuple[Enum, int]:
        """
    ...
    def __getitem__(
        ...
        key: Union[
            ...
            ellipsis,
            None,
            Tuple[Union[int, slice, ellipsis, _ARR_C, None], ...],
            _ARR_C,
        ],
        /,
    ) -> _ARR_C:
    ...
    def __setitem__(
        self: _ARR_C,
        key: Union[
            int, slice, ellipsis, Tuple[Union[int, slice, ellipsis, _ARR_C], ...], _ARR_C
        ],
        ...
        self: _ARR_C
            array instance.
        key: Union[int, slice, ellipsis, Tuple[Union[int, slice, ellipsis, _ARR_C], ...], array]
            index key.
